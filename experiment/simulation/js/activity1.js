...
function activity1() {
    ...
    <div class='divide'>
        <div style='margin-top: 2vw;'>
            <br>
            <h4 class="center-text fs-20px fw-600">Interpolation: &beta;-Spline Interpolation</h4>
...
function start_act1() {
    ...
    <div class='collapse center-text divide' style='style='margin-top: 2vw; 'width: 80%; margin: auto;' id='tb1-box'>
        ...
        $$ x(u) = \\frac{(1-u)^3 x_1}{6} + \\frac{(3u^3 - 6u^2 + 4)x_2}{6} + \\frac{(-3u^3 + 3u^2 + 3u + 1)x_3}{6} + \\frac{u^3 x_4}{6} $$
        $$ y(u) = \\frac{(1-u)^3 y_1}{6} + \\frac{(3u^3 - 6u^2 + 4)y_2}{6} + \\frac{(-3u^3 + 3u^2 + 3u + 1)y_3}{6} + \\frac{u^3 y_4}{6} $$
